  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pb-24 pt-10">
      ...
      <section className="glass mt-6 rounded-3xl p-6 sm:p-8">
        <h2 className="text-lg font-medium text-zinc-100">Categorías de cookies</h2>
      ...
      <section className="glass mt-6 space-y-6 rounded-3xl p-6 sm:p-8">
        <div>
          <h2 className="text-lg font-medium text-zinc-100">Cookies necesarias</h2>
          <p className="mt-2 text-sm text-zinc-400">
            Estas cookies las gestiona Supabase para mantener tu sesión iniciada de
            forma segura. Sin ellas no podrías acceder a tu cuenta, favoritos ni
            historial. No requieren consentimiento porque son imprescindibles para el
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-400">
            ...
            para cuando se activen en el futuro; en ese caso solo se cargarán si has
      ...
      <section className="glass mt-6 rounded-3xl p-6 sm:p-8">
        <h2 className="text-lg font-medium text-zinc-100">Gestionar tu consentimiento</h2>
        <p className="mt-2 text-sm text-zinc-400">
