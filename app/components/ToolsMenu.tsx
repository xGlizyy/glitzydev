          ...
          >
            {TOOLS.map((tool) => (
              <Link
                ...
                className="flex items-center justify-between gap-2.5 rounded-xl px-3 py-2.5 font-industrial text-xs tracking-wide text-zinc-100 transition hover:bg-orange-400/10"
              >
                {tool.label}
