    ...
    <div className="mx-auto flex min-h-screen max-w-3xl flex-col items-center gap-10 px-6 pb-24 pt-36">
      <div className="flex w-full flex-col items-center gap-4 text-center">
        <h1 className="text-2xl font-semibold text-zinc-50 sm:text-3xl">
          Resúmenes y preguntas de examen desde un PDF
        </h1>
        <p className="max-w-xl text-sm text-zinc-400">
          Sube un PDF con tus apuntes o un tema y genera un resumen junto a preguntas tipo examen
          para repasar.
        </p>
      </div>
      ...
      <form
        ...
        className="glass flex w-full max-w-xl flex-col items-center gap-4 rounded-3xl p-6"
      >
        <input
          type="file"
